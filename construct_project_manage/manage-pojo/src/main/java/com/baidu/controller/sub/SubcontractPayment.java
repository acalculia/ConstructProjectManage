package com.baidu.controller.sub;
...
@AllArgsConstructor
@NoArgsConstructor
@TableName("subcontract_payment")
public class SubcontractPayment implements Serializable {
    private static final long serialVersionUID = 151797260575461410L;
    /**
    * 编号
    */
    private Integer id;
