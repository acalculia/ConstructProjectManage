...
/**
 * 进度款申报(ApplyProgressPayment)实体类
 *
 * @author makejava
...
@AllArgsConstructor
@NoArgsConstructor
@TableName("apply_progress_payment")
public class ApplyProgressPayment implements Serializable {
    private static final long serialVersionUID = 104461962902718977L;
    /**
    * 编号
    */
    private Integer id;
