...
/**
 * 劳务付款(ApplyLaborPayment)实体类
 *
 * @author makejava
 * @since 2020-09-29 15:19:35
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName("apply_labor_payment")
public class ApplyLaborPayment implements Serializable {
    private static final long serialVersionUID = -54104216916171130L;
    /**
    * 编号
    */
    private Integer id;
